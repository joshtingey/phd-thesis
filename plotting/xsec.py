...
def make_plots(in_file, out_name):
    ...
    for i in range(size): 
        x_bin = 0.0
        dis_cc_p, res_cc_p, dis_nc_p, qel_nc_p, res_nc_p = 0.0
        dis_cc_n, res_cc_n, dis_nc_n, qel_nc_n, res_nc_n = 0.0
        ...
        x.append(x_bin)
        dis_cc.append(dis_cc_p + dis_cc_n)
        res_cc.append(res_cc_p + res_cc_n)
        dis_nc.append(dis_nc_p + dis_nc_n)
        qel_nc.append(qel_nc_p + qel_nc_n)
        res_nc.append(res_nc_p + res_nc_n)
