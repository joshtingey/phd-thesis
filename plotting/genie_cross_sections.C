void make_plots(const char * in_file, const char * out_name)
{
    ...
    TH2F *hempty = new TH2F("hempty", ";Neutrino Energy (GeV); O^{16} #nu cross section/E_{#nu} (10^{-38} cm^{2} / GeV)", 1, 0, 10, 1, 1e-2, 20);
    CenterTitles(hempty);
    ...
    TString png_cc = "../diagrams/cvn/genie_cross_sections_cc_";
    png_cc += out_name;
    png_cc += ".png";
    TString macro_cc = "./output/genie_cross_sections_cc_";
    macro_cc += out_name;
    macro_cc += ".C";

    TString png_nc = "../diagrams/cvn/genie_cross_sections_nc_";
    png_nc += out_name;
    png_nc += ".png";
    TString macro_nc = "./output/genie_cross_sections_nc_";
    macro_nc += out_name;
    macro_nc += ".C";
...
void genie_cross_sections()
{
    make_plots("data/nuel_xsec.root", "nu_e_O16");
    make_plots("data/anuel_xsec.root", "nu_e_bar_O16");
    make_plots("data/numu_xsec.root", "nu_mu_O16");
    make_plots("data/anumu_xsec.root", "nu_mu_bar_O16");
}