...
def flux():
    ...
    root_file = ROOT.TFile("./data/flux/flux.root")
    nuel_cc_h = root_file.Get("enufullfine_nue_allpar_tot_cc_CHIPSoffAXIS")
    anuel_cc_h = root_file.Get("enufullfine_anue_allpar_tot_cc_CHIPSoffAXIS")
    numu_cc_h = root_file.Get("enufullfine_numu_allpar_tot_cc_CHIPSoffAXIS")
    anumu_cc_h = root_file.Get("enufullfine_anumu_allpar_tot_cc_CHIPSoffAXIS")
    nuel_nc_h = root_file.Get("enufullfine_nue_allpar_tot_nc_CHIPSoffAXIS")
    anuel_nc_h = root_file.Get("enufullfine_anue_allpar_tot_nc_CHIPSoffAXIS")
    numu_nc_h = root_file.Get("enufullfine_numu_allpar_tot_nc_CHIPSoffAXIS")
    anumu_nc_h = root_file.Get("enufullfine_anumu_allpar_tot_nc_CHIPSoffAXIS")
    nuel_flux_h = root_file.Get("enufullfine_nue_allpar_NoXSec_CHIPSoffAXIS")
    anuel_flux_h = root_file.Get("enufullfine_anue_allpar_NoXSec_CHIPSoffAXIS")
    numu_flux_h = root_file.Get("enufullfine_numu_allpar_NoXSec_CHIPSoffAXIS")
    anumu_flux_h = root_file.Get("enufullfine_anumu_allpar_NoXSec_CHIPSoffAXIS")
