...
All three event maps: hit-charge, hit-time, and hough-height are down-sampled using 8-bit
encoding, by converted each 32-bit float value to an integer between 0 and 255. Encoding not only
