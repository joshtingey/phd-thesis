...
\SI{25}{\text{m}} wide and \SI{12}{\text{m}} high, \chipsfive has an inner surface area of
\SI{1924}{\text{m}^2} and a total target mass of \SI{5.9}{\text{kt}}. Via the process of design,
construction, deployment, and data taking, \chipsfive primarily aims to refine the \chips concept
for future full-scale ($\sim$\SI{15}{\text{kt}}) modules. Consequently, \chipsfive is designed
...
pipes, each \SI{16}{\text{inches}} in diameter, are attached to the frame of the top-cap to make
...
\emph{Madison} \textsc{Pom}s use \SI{3}{\text{inch}} wide Hamamatsu PMTs~\cite{hamamatsu}, with
...
consists of a 20 inch \SI{10}{\micro\text{m}} carbon block filter followed by a 20 inch
\SI{0.5}{\micro\text{m}} polypropylene filter, as shown in \FigureRef{fig:filtration}. This
configuration is found to achieve a photon attenuation length of \SI{133\pm2}{\text{m}} after
...
to estimate their values at \SI{1}{\text{m}} above the detector. All muons whose path does not
