...
configuration is found to achieve a photon attenuation length of $133\pm2~m$ after a few months of
...
In order to describe the \chipsfive detector description just described in a simulated environment
a Monte Carlo detector simulation framework is used specifically designed for such detectors.
...
reflectivity. In this work an photon attenuation length of \unit{50}{\mathrm{m}} at
