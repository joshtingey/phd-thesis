...
ore mine pit, owned by Cliffs natural resources. Centre located \unit{7}{\mathrm{mrad}} or \numi
axis at a distance of \unit{712}{\mathrm{km}} from beam target, at a latitude of 47.58N and
longitude of 92.13W, approximately \unit{60}{\mathrm{m}} maximum depth much deeper than standard
lake, $0.8\mathrm{km}\times0.8\mathrm{km}$ in size, heavy infrastructure for heavy industry with
power and roads, Polymet mining administration build is $\sim$\unit{712}{\mathrm{km}} from pit
...
- \unit{12.5}{\mathrm{m}} radius, \unit{25}{\mathrm{m}} diameter, \unit{12}{\mathrm{m}} tall,
\unit{1924}{\mathrm{m}^2} surface area, \unit{5.9}{\mathrm{kton}} total volume,
