...
\unit{400}{\mathrm{nm}}, compared to the low 12.0\% ratio achieved by the R6091 PMTs.
...
Assuming a \chipsfive water overburden of \unit{50}{\mathrm{m}} and a
\unit{2.2}{\MeV/\mathrm{cm}^{2}} muon energy loss as suggested in Ref.~\cite{klimushin2001} the
muon parameters are updated to represented the distribution \unit{1}{\mathrm{m}} above the top of
...
Shown is for a cylindrical detector of both height and diameter of \unit{24}{\mathrm{m}}, we use a
rate of
...
- In spill cosmic muon occupancy is 8.9\% for \unit{10}{\mu\mathrm{s}} long \numi spill!
- Events take under \unit{100}{\mu\mathrm{ns}} to unfold
