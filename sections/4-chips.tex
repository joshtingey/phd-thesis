...
\numi beam achieves an intensity of \unit{700}{\mathrm{kW}} (\unit{740}{\mathrm{kW}} at peak)
...
the \unit{7}{\mathrm{mrad}} off-axis \chipsfive module.
...
\end{equation}
Again using $n\sim 1.33$, a threshold energy of $\sim$\unit{1.5}{\mathrm{m}} is typical.
...
range of wavelengths for which PMTs are typically sensitive, \unit{350}{\mathrm{nm}} to
...
allows for a water overburden of approximately \unit{50}{\mathrm{m}} with \chipsfive resting on
...
\unit{3}{\mathrm{inch}} Hamamatsu R6091 PMTs donated from the NEMO 3 experiment~\cite{arnold2005}
...
the photon hit time resolution is $\sim$\unit{2}{\mathrm{ns}} and $\sim$\unit{5}{\mathrm{ns}} for
the \unit{88}{\mathrm{mm}} HZC and R6091 PMTs respectively.
...
the \unit{6}{\mathrm{atm}} of water pressure at the bottom of the pit. A fully assembled and
...
geomembrane liner, the \unit{1.3}{\mathrm{m}} high region allows for the rejection of
predominantly downward going cosmic muons by detecting the Cherenkov radiation they produce. A
total of $324$ upward-facing \unit{88}{\mathrm{mm}} HZC veto PMTs within the top-cap Nikhef POMs
...
necessary \unit{30}{\mathrm{m}} photon attenuation length. Therefore, a high volume pump is
...
configuration is found to achieve a photon attenuation length of \unit{133\pm2}{\mathrm{m}} after
...
height to \unit{8}{\mathrm{m}}. In October 2019 this version of \chipsfive (shown in
...
reflectivity. In this work a photon attenuation length of \unit{50}{\mathrm{m}} at
...
inner detector volume, while cosmic vertices are kept at \unit{1}{\mathrm{m}} above the detector
...
\unit{200}{\mathrm{ns}} windows are grouped to form a single recorded hit, with a smeared first
...
information and track descriptions. A full event takes approximately \unit{3}{\mathrm{seconds}} to
...
\unit{11.8}{\mathrm{KHz}} at \unit{50}{\mathrm{m}} of overburden.
