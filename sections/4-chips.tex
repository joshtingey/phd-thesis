...
in shape and \SI{25}{\text{m}} in diameter and \SI{12}{\text{m}} in height, \chipsfive has an
inner surface area of \SI{1924}{\text{m}^2} and a total target mass of \SI{5.9}{\text{kt}}. Via
the process of design, construction, deployment, and data taking, \chipsfive primarily aims to
refine the \chips concept for future full-scale ($\sim$\SI{15}{\text{kt}}) modules. Consequently,
...
\ChapterRef{chap:cnn} and \ChapterRef{chap:results}) a conservative photon attenuation length of
