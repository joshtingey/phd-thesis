...
\begin{itemize}
    ...
    \item \textbf{Water filtration:} This effort aims to prove that adequate water purity can be
          ...
          lengths, greater than \unit{50}{\mathrm{m}} are possible.
...
\unit{300}{\mathrm{m}} of absorption rock: The spectrometer MINERvA, the near detector for MINOS
...
\begin{figure} % OFF-AXIS FLUX DIAGRAM %
    ...
    {Muon neutrino flux for different \numi detectors at different off-axis angles. Shown are the
        neutrino energy spectrum for MINOS (on-axis), \nova (\unit{14}{\mathrm{mrad}} off-axis), and
        \chipsfive (\unit{7}{\mathrm{mrad}} off-axis). Figure taken from Ref.~\cite{adamson2013}.}
    \label{fig:numi_axis}
\end{figure}
