...
\SI{25}{\text{m}} in diameter and \SI{12}{\text{m}} in height, \chipsfive has an inner surface
area of \SI{1924}{\text{m}^2} and a total target mass of \SI{5.9}{\text{kt}}. Via the process of
design, construction, deployment, and data taking, \chipsfive primarily aims to refine the \chips
concept for future full-scale ($\sim$\SI{15}{\text{kt}}) modules. Consequently, \chipsfive is
...
Firstly, \emph{Nikhef} \textsc{Pom}s use \SI{88}{\text{mm}} wide HZC PMTs~\cite{hzc}, with
electronics developed for the KM3NeT experiment~\cite{katz2009, adrian2016}. Secondly,
\emph{Madison} \textsc{Pom}s use \SI{76}{\text{mm}} wide Hamamatsu PMTs~\cite{hamamatsu}, with
...
photon attenuation length of \SI{50}{\text{m}} at \SI{405}{\text{nm}} is used with negligible
...
\SI{200}{\text{ns}} windows are grouped to form a single recorded hit, with a smeared first hit
...
\begin{figure} % COSMIC RATE DIAGRAM %
    ...
    {Expected cosmic muon rate as a function of water overburden depth for a \SI{24}{\text{m}}
        high and \SI{24}{\text{m}} wide \chips detector module. Shown are fits made to the work
