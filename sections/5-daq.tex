...
approaches to solve the constraints of the \chips concept. Namely, deployment within a body of
water and a limited resource budget. In this chapter, the DAQ system for \chips as applied to the
\chipsfive prototype detector module is described. The description is presented in two broad
categories, hardware and software, with a short description of the timing system to begin.
...
Small Form-Factor Pluggable Transceivers (SFPs). Fig.~\ref{fig:sync} shows the WR synchronised
...
Fig.~\ref{fig:full_setup}. This central container acts as the interface between the detector
...
\chipsfive detector, as shown in Fig.~\ref{fig:manifold}, usually attached to the endcap frames.
...
\unit{100}{\text{KHz}} was observed across all PMTs. This was expected due to the extended period
...
system corresponding to a peak WR network throughput of \unit{5.66}{\text{Gb per second}} of hit
