...
\unit{10}{\mathrm{ms}} long time windows. At the end of each window, collected hits are packaged
...
Jumbo UDP packets of maximum size \unit{9000}{\mathrm{bytes}} are used instead of typical
\unit{1500}{\mathrm{byte}} packets. This is done to both reduce the proportion of bandwidth taken
...
\unit{150}{\mathrm{KHz}} was observed across all PMTs. With a veto on PMTs over
\unit{100}{\mathrm{KHz}} per window the average data reat
...
\begin{itemize}
    ...
    Beaglebones. At the end of every \unit{10}{\mathrm{ms}} long PMT hit data taking window both
