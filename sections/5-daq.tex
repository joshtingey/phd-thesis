...
(Inter-Range Instrumentation Group timecode B) and a \unit{10}{\mathrm{MHz}} signal from a GPS
...
Seven Solutions~\cite{wrlen2020}. All WR components are connected using \unit{1}{\mathrm{Gb}}
...
\chipsfive WR switches separated by \unit{500}{\mathrm{m}} of fibre. With the vertical ticks
...
Up to 16 $\mu$DAQs receive power, networking, and IRIG-B and \unit{10}{\mathrm{MHz}} timing
...
clock synchronised IRIG-B and \unit{10}{\mathrm{MHz}} timing signals are output by the WR-LEN to
...
bi-directional \unit{1}{\mathrm{Gb}} connections over the single \unit{500}{\mathrm{m}} long
...
The standard network switch provides \unit{10}{\mathrm{Gb}} connections to each of the Shore DAQ
...
power for up to \unit{15}{\mathrm{minutes}} after a power cut (surprisingly quite common).
