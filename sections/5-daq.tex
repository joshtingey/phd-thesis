...
TALK ABOUT GENERAL SOFTWARE AND THE MACHINES USED
- Need to talk about what is novel, new and exciting!
- Limited resources but still greater modern performance, use new things easily perk of small
collaboration.
...
- Software repository at~\cite{chipsdaq2020}
...
- Shore DAQ-1 used for hit acquisition and Shore DAQ-2 used for control and monitoring. Want all
processing resources available on a single machine for hit acquisition as this is the process that
must take precedence over all else, as we do not want to loose hits.
- The complete DAQ software implementation for \chipsfive is presented in terms of the flow of data
between components within Fig.~\ref{fig:daq_software}.
