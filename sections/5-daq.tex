...
with the corresponding multiplexer/demultiplexer at the other end of the \unit{500}{\mathrm{m}}
...
The two umbilical input power connections are distributed via two copper plates to a series of
