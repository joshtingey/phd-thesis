...
\begin{figure} % NIKHEF PMT AND CLB DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \subcaptionbox{nikhef pmt\label{fig:nikhef_pmt}}{%
        \includegraphics[height=10cm]{diagrams/6-daq/nikhef_pmt.jpg}%
    }
    \quad
    \subcaptionbox{clb\label{fig:clb}}{%
        \includegraphics[height=10cm]{diagrams/6-daq/clb.jpg}%
    }
    \caption[The caption]
    {The caption}
\end{figure} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure} % PMT ASSEMBLY DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \subcaptionbox{pmt disassembled\label{fig:pmt_disassembled}}{%
        \includegraphics[height=5cm]{diagrams/6-daq/pmt_disassembled.jpg}%
    }
    \quad
    \subcaptionbox{pmt assembled\label{fig:pmt_assembled}}{%
        \includegraphics[height=5cm]{diagrams/6-daq/pmt_assembled.jpg}%
    }
    \caption[The caption]
    {The caption}
\end{figure} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure} % CLB ROCKETS DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \includegraphics[width=0.8\textwidth]{diagrams/6-daq/rockets.jpg}
...
\begin{figure} % NIKHEF PLANE DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \includegraphics[width=0.8\textwidth]{diagrams/6-daq/single_plane.jpg}
...
\begin{figure} % TOT DIAGRAM DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \includegraphics[width=0.8\textwidth]{diagrams/6-daq/tot.pdf}
    \caption[tot short]
    {tot long}
    \label{fig:tot}
\end{figure} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure} % BEAGLEBONE AND DANOUT DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \subcaptionbox{beaglebone\label{fig:beaglebone}}{%
        \includegraphics[height=7cm]{diagrams/6-daq/beaglebone.jpg}%
    }
    \quad
    \subcaptionbox{danout\label{fig:danout}}{%
        \includegraphics[angle=90, height=7cm]{diagrams/6-daq/danout.jpg}%
    }
    \caption[The caption]
    {The caption}
\end{figure} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure} % BADGER BOARD DIAGRAM %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    \includegraphics[angle=90,origin=c,width=\textwidth]{diagrams/6-daq/badger.jpg}
