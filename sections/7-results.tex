...
\begin{table}
    ...
    \begin{tabular}{lrrrrr}
        Selection      & App CC $\nu_{e}$ & CC $\nu_{\mu}$ & Beam CC $\nu_{e}$ & NC & Cosmic \\
        \midrule
        Total events   & $44.17\pm0.15$ & $2045.9\pm5.8$ & $35.06\pm0.08$ & $354.7\pm2.4$ & $2100000\pm4200$ \\
        + Preselection & $41.21\pm0.14$ & $1889.5\pm5.6$ & $33.52\pm0.08$ & $243.2\pm2.0$ & $430000\pm1900$ \\
...
\TableRef{tab:energy_resolutions}, given as a fractional percentage.
...
\begin{table}
    ...
    {Summary of CC $\nu_{e}$ and CC $\nu_{\mu}$ neutrino energy FWHM values. Shown for each sample
        ...
        difference distributions shown in \FigureRef{fig:final_energy_frac} and
        \FigureRef{fig:final_energy_frac_split}, and given as a fractional percentage. The given
