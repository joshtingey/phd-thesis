...
a typical \unit{100}{\mathrm{ns}} event. Therefore, excellent beam classification robustness is
...
- Networks not as clever as you think, they play the statistics game.
- Future work could define a loss function to minimise that quantifies the actual physics
sensitivity as just optimising the accuracy across the sample is probably not the best way of
doing it as under represented events could be really important.
...
- We are looking at a different problem which is basically subtle changes to rings, rather than
the broad range of features that can be learnt in ImageNet for example.
