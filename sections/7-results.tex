...
TODO: Write the robustness section of the results chapter
...
- We can learn a lot about how the networks behave by looking at alternative implementations that
do not perform as well. Input event representation is important! Input distribution of events is
very important!
...
Three different approaches are explored in this work! Problem is not that difficult as the
architecture doesn't matter that much! Maybe we just need larger images for that to become a
thing!
