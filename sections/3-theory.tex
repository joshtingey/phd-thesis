...
(\unit{1285}{\mathrm{km}} from DUNE) named the Long-Baseline Neutrino Facility
(LBNF)~\cite{acciarri2016_lbnf}. Replacing the current \unit{700}{\mathrm{kW}} NuMI beam, LBNF is
