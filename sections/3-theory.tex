...
\FigureRef{fig:z_resonance}), as well as the Mark II experiment at SLAC~\cite{abrams1989}, made
...
The eighteen quarks (all colours considered) and six leptons, all spin $1/2$ particles, are named
...
\begin{figure} % NUEL COHERENT SCATTERING DIAGRAM %
    \feynmandiagram[vertical'=a to b] {
        i1 [particle=\(e^{-}\)] --[anti fermion] a --[anti fermion] f1 [particle=\(\nu_{e}\)],  
...
\begin{figure} % CC DIAGRAM %
    \feynmandiagram[vertical'=a to b] {i1 [particle=\(l^{-}\)]-- [anti fermion] a-- [anti fermion] f1
    [particle=\(\nu_{l}\)], a -- [boson,edge label=\(W^{+}\)] b, i2 [particle=\(n\)]-- [fermion] b--
...
\begin{figure} % XSEC NUEL DIAGRAM %
    ...
    {\textsc{Genie} cross-sections on oxygen divided by neutrino energy for CC $\nu_{e}$ (left)
        ...
        \ReferenceRef{andreopoulos2015} for generation details.}
...
\begin{figure} % BEST FIT DIAGRAM %
    ...
    {Three-flavour results from the NuFIT v5.0 global fit as of July 2020, showing both 1$\sigma$
        ...
        in \SectionRef{sec:theory_status_open}. The lower section includes atmospheric neutrino
        data from the Super-Kamiokande experiment, while the upper section does not. Figure taken
        from \ReferenceRef{esteban2020}.}
    \label{fig:best_fit}
\end{figure}
