...
Group's 2020 Review of Particle Physics (see \ReferenceRef{particle2020}). Below, the solar,
...
\EquationRef{eq:chips_prob} allows for the octant to be resolved. Current results suggest the
...
the \emph{inverted hierarchy}, as illustrated in \FigureRef{fig:hierarchy}. Resolving this
...
water Cherenkov detector, \SI{60}{\text{m}} in height and \SI{74}{\text{m}} in diameter, built
under \SI{650}{\text{m}} of rock at the Tochibora mine in Japan, close to the current
...
Primarily this will increase the beam power from the current record of \SI{515}{\text{kW}} to
\SI{1.3}{\text{MW}}. In total, the Hyper-Kamiokande project is expected to cost nearly \$700
