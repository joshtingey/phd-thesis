...
the rejection of a sizeable cosmic ray background. Firstly, a prompt positron annihilation,
...
a key background to both the Kamiokande and IMD experiments, designed to measure proton decay
primarily. When evaluating the background, a deficit in the number of muon neutrinos compared to
...
beams) and larger and larger detectors. Below we outline the current status, open questions, and
future for neutrino physics.

\subsection{Current status} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\label{sec:theory_status_current} %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

The current state of neutrino physics is summarised by global fits to neutrino oscillation data.
...
Whilst, Super-Kamiokande is a large water Cherenkov detector containing \unit{50}{\mathrm{kt}} of
pure water, equipped with eleven-thousand PMTs, and located \unit{1}{\mathrm{km}} underground in
