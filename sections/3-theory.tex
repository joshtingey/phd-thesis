...
\FigureRef{fig:sm}, all have an associated anti-particle with the same quantum numbers except the
...
The twelve quarks (ignoring colour) and twelve leptons, all spin $1/2$ particles, are named
...
via the first term in \EquationRef{eq:chips_prob} allows for the octant to be resolved. Current
