...
\TableRef{tab:final_metrics}, with a comparison of the metrics available for the old
likelihood-based approach given in \TableRef{tab:final_comparison}.
...
\begin{table}
    ...
    \begin{tabular}{lrrr}
        ...
        \midrule
        QEL $\nu_{e}$ lepton energy res   & $33.3\pm4.1\%$  & $10.0\pm0.1\%$  & $30\pm4\%$ \\
        QEL $\nu_{\mu}$ lepton energy res & $23.2\pm3.7\%$  & $9.0\pm0.1\%$   & $39\pm6\%$ \\
    \end{tabular}
    ...
    $\nu_{e}$ beam selection, as well as the QEL event lepton energy resolutions (defined as the
    FWHM of the (reco-true)/true energy distribution) for both CC $\nu_{e}$ and CC $\nu_{\mu}$
