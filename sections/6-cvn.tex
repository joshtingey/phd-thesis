...
%\begin{figure} % AMOUNT OF DATA DIAGRAM %
%    \includegraphics[width=0.5\textwidth]{diagrams/6-cvn/amount_of_data.png}
%    \caption[Illustrative plot of the amount of data vs the expected performance.]
%    {Illustrative plot of the amount of data vs the expected performance for traditional and
%        neural network machine learning models. Figure taken from Ref.~\cite{mehta2019}.}
%    \label{fig:amount_of_data}
%\end{figure}
