...
%        \frame{\includegraphics[width=5cm]{diagrams/6-cvn/conv_input.pdf}}
...
%    \begin{subfigure}[b]{5cm}
%        \centering
%        \frame{\includegraphics[width=5cm]{diagrams/6-cvn/conv_kernel.pdf}}
%        \label{fig:conv_kernel}
%    \end{subfigure}
%
%    %\caption{conv_input and conv_kernel long}
%\end{figure}
